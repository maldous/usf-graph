  ...
  return Object.freeze({
    ...
    authorityWitness: Object.freeze({
      ...
      settled: Object.freeze({
        ...settledWitness,
        // Informational only. The guard derives stability from complete phase
        // equality and merely cross-checks this value, so it is never evidence.
        stable: settledWitness.digest === afterWitness.digest
          && settledWitness.graphCount === afterWitness.graphCount
          && settledWitness.triples === afterWitness.triples,
      }),
    }),
  });
}
