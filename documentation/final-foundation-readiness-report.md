...
- Cases: **92** (20 projection + 12 bootstrap + 11 model/rule + 20 publication
  witness/receipt + 4 reserved applicability + 13 plan/apply + 8 authority movement
  + 4 second-path structural)
...
- Canonical validation: `npm run test:semantic-assurance` → **229 tests, 229
  pass, 0 fail, 0 skipped** (220 after the first review pass; 208 before it; 195 at
  PR #17; 180 at the pre-correction baseline)
...
and the second-pass R6 (the exported duplicate materialisation API) by C16, together
with verdict-read stability by C15.
