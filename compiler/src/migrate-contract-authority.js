...
const GRAPH_DIR = process.env.USF_GRAPH_DIR || join(REPOSITORY_ROOT, 'graph');
const CONTRACT_DIR = join(REPOSITORY_ROOT, 'spec/instances/semantic-contract');
const CENSUS_ARTIFACTS = join(process.env.USF_CENSUS_DIR || join(REPOSITORY_ROOT, 'census'), 'artifacts.jsonl');
